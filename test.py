...
This tool compares development costs of housing units against AMI-based affordable purchase thresholds
for Vermont regions (Chittenden, Addison, Vermont), based on unit type, size, and estimated bedrooms.
